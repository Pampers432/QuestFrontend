  ...
  return (
    <div style={{ position: "relative", minHeight: "calc(100vh - 64px)" }}>
      ...
      <div style={{ position: "absolute", top: 0, left: 0, width: "100%", zIndex: 0 }}>
        <PaintedDots style={{ position: "absolute", top: "8%", right: "5%", width: 160, height: 160, opacity: 0.15 }} />
      </div>
      ...
      />
      <PageSparkle
        style={{ position: "fixed", top: "70%", right: "8%", width: 35, height: 35, opacity: 0.25, zIndex: 1 }}
