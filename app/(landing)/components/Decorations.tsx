...
export function SparkleDoodle({ className = "", style }: { className?: string; style?: React.CSSProperties }) {
  return (
    <svg
      ...
      style={style}
    >
      {/* Four-point child-drawn sparkle */}
      <path
        d="M20 2 Q18 18 2 20 Q18 22 20 38 Q22 22 38 20 Q22 18 20 2Z"
...
export function TreeDoodle({ className = "", style }: { className?: string; style?: React.CSSProperties }) {
  return (
    ...
    >
      ...
      {/* Canopy - layered circles like a child draws */}
...
export function PaintedDots({ className = "", style }: { className?: string; style?: React.CSSProperties }) {
  return (
    ...
    >
      ...
      {/* Squiggly doodle line */}
      <path
        d="M10 50 Q30 40 50 55 T90 50 T130 60 T160 45 T190 55"
      ...
      />
      <path
        d="M20 140 Q40 130 60 145 T100 135 T140 145 T170 130 T190 140"
...
export function ZigzagBg({ className = "", color = "var(--color-orange)" }: { className?: string; color?: string }) {
  return (
    ...
    >
      <path
        d="M0 80 L40 30 L80 70 L120 20 L160 60 L200 10 L240 50 L280 0 L320 40 L360 0 L400 30 L400 120 L0 120 Z"
        fill={color}
        opacity="0.06"
      />
      <path
        d="M0 100 L60 50 L120 85 L180 40 L240 75 L300 30 L360 65 L400 50 L400 120 L0 120 Z"
        fill={color}
        opacity="0.04"
      />
    </svg>
